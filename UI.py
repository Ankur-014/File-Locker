...
class Project:
    def __init__(self,master):
        ...
        self.br_btn = Button(self.toolbar,image=self.browse,text="Choose File",font="Helvetica 14 bold",compound=TOP,command=self.fileBrowsing,fg="brown")
        self.lock_btn = Button(self.toolbar,image=self.lock,text="Encrypt",font="Helvetica 14 bold",compound=TOP,command=self.encrypt,fg="brown")
        self.unlock_btn = Button(self.toolbar,image=self.unlock,text="Decrypt",font="Helvetica 14 bold",compound=TOP,command=self.decrypt,fg="brown")
        ...
        label = Label(master,height = 5,text="List of Encrypted Files: ",font="Helvetica 16 italic")
        label.pack()
